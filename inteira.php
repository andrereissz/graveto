                        ...
                        <div class="col col-100">
                            <p class="form-control text-monospace my-2 w-100" type="text">
                                ...
                                for ($i = 0; $i < count($GLOBALS['variaveis']); $i++) {
                                    $resposta = $resposta . '(' . $GLOBALS['valores'][$i] . ') · (' . $GLOBALS['zresultado'][$i] . ')';
                                    if ($i != count($GLOBALS['variaveis']) - 1) {
                                        $resposta = $resposta . ' + ';
                                    }
                                    $valorresposta += $GLOBALS['valores'][$i] * $GLOBALS['zresultado'][$i];
                                }
                                $resposta = $resposta . ' = ' . $valorresposta;
                                echo $resposta;
                                ?>
                            </p>
                        </div>
